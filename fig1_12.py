...
plt.legend([p1,p2,p3],["\sigma=0dBsm","\sigma=-10dBsm","\sigma=-20dBsm"],loc='upper right')
plt.grid()    
...
snr3 = radarEq.eq_1p56(pt*1.8,freq,g,sigma*10,te,b,nf,loss,distance)
p1, = plt.plot(distancekm,snr3,color='r',marker='+')
p2, = plt.plot(distancekm,snr1,color='k',marker='+')
p3, = plt.plot(distancekm,snr2,color='b',marker='+')
plt.legend([p1,p2,p3],["Pt=2.16 MW","Pt=1.5 MW","Pt=0.6MW"],loc='upper right')
plt.grid()    
plt.xlabel('Dectection range -Km')
plt.ylabel('SNR -dB')
