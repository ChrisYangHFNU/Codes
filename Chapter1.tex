  ...
  \begin{columns}
    \begin{column}{0.45\linewidth}
      \begin{empheq}[box=\widefbox]{align*}
        ...
        & \nabla_t\times\vec H_{t}=j\omega\epsilon\hat z E_z \\
        & \nabla_t\times \hat z H_z+\hat z\times\frac{\partial \vec{H_t}}{\partial z}
        = j\omega\epsilon\vec{E_t}
        %\tikzmarkend{c}
      \end{empheq}
      $\times j\omega\mu$
    \end{column}
    \begin{column}{0.5\linewidth}
      \begin{empheq}[box=\widefbox]{align*}
        & \nabla_t\times\vec E_{t}=-j\omega\mu\hat z H_z \\
        & \nabla_t\times \hat z E_{z}+\hat z\times\frac{\partial \vec{E_t}}{\partial z}
        = -j\omega\mu\vec{H_t}
      \end{empheq}
      $\hat{z}\times\frac{\partial}{\partial z}$
    \end{column}
  \end{columns}
  \begin{align*}
    \flushleft
    j\omega\mu\hat{z}\times\frac{\partial \vec{H_{t}}}{\partial z}=-j\omega\mu\nabla_{t}\times\hat{z}H_{z}-\omega^{2}\mu\epsilon\vec{E_{t}}
  \end{align*}
  \begin{align*}
    \flushright
    -j\omega\mu\hat{z}\times\frac{\partial \vec{H_{t}}}{\partial z}=\hat{z}\times\frac{\partial}{\partial z} \left(\nabla_{t}\times\hat{z}E_{z}\right)+\hat{z}\times\frac{\partial}{\partial z} \left(\hat{z} \times \frac{\partial \vec{E_{t}}}{\partial z} \right)
  \end{align*}
  % draw arrows
  %\begin{tikzpicture}
    % define two coordinates at bottom of each equation box
    %\coordinate (aa) at ($(c)+(5mm,-1.3cm)$);
    % draw arrow down and place node below
    %\draw [->] (aa) --++(0,-3mm) node[below] (bi) {$\beta_i$}
  %\end{tikzpicture}
\end{frame}
