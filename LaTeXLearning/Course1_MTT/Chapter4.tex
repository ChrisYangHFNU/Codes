...
\begin{frame}{Smith圆图的特点}
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.6\linewidth}
      \only<1>{\includegraphics[width=7cm]{Cha4//MatchShortOpen1.pdf}}
      \only<2>{\includegraphics[width=7cm]{Cha4//MatchShortOpen2.pdf}}
      \only<3>{\includegraphics[width=7cm]{Cha4//MatchShortOpen3.pdf}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Smith圆图的特点}
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.6\linewidth}
      \only<1>{\includegraphics[width=7cm]{Cha4//bofubojie1.pdf}}
      \only<2>{\includegraphics[width=7cm]{Cha4//bofubojie2.pdf}}
      \only<3>{\includegraphics[width=7cm]{Cha4//bofubojie3.pdf}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Smith圆图的应用}
  ...
  \begin{columns}
    ...
    \begin{column}{0.6\linewidth}
      ...
      \only<1>{\includegraphics[width=6.5cm]{Cha4//SCexample1-eps-converted-to.pdf}}
      \only<2>{\includegraphics[width=6.5cm]{Cha4//SCexample2-eps-converted-to.pdf}}
      \only<3>{\includegraphics[width=6.5cm]{Cha4//SCexample3-eps-converted-to.pdf}}
      \only<4>{\includegraphics[width=6.5cm]{Cha4//SCexample4-eps-converted-to.pdf}}
      \only<5>{\includegraphics[width=6.5cm]{Cha4//SCexample5-eps-converted-to.pdf}}
      \only<6>{\includegraphics[width=6.5cm]{Cha4//SCexample6-eps-converted-to.pdf}}
      \only<7>{\includegraphics[width=6.5cm]{Cha4//SCexample7-eps-converted-to.pdf}}
      \only<8>{\includegraphics[width=6.5cm]{Cha4//SCexample8-eps-converted-to.pdf}}
      \only<9>{\includegraphics[width=6.5cm]{Cha4//SCexample9-eps-converted-to.pdf}}
      \only<10>{\includegraphics[width=6.5cm]{Cha4//SCexample10-eps-converted-to.pdf}}
      \only<11>{\includegraphics[width=6.5cm]{Cha4//SCexample11-eps-converted-to.pdf}}
...
\begin{frame}{Smith圆图的应用}
  ...
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.6\linewidth}
      \only<1>{\includegraphics[width=6.5cm]{Cha4//fig4-11-1.pdf}}
      \only<2>{\includegraphics[width=6.5cm]{Cha4//fig4-11-2.pdf}}
      \only<3>{\includegraphics[width=6.5cm]{Cha4//fig4-11-3.pdf}}
      \only<4>{\includegraphics[width=6.5cm]{Cha4//fig4-11-4.pdf}}
      \only<5>{\includegraphics[width=6.5cm]{Cha4//fig4-11-5.pdf}}
      \only<6>{\includegraphics[width=6.5cm]{Cha4//fig4-11-6.pdf}}
      \only<7>{\includegraphics[width=6.5cm]{Cha4//fig4-11-7.pdf}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Smith圆图的应用}
  ...
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.6\linewidth}
      \only<1>{\includegraphics[width=7cm]{Cha4//fig4-12-1.pdf}}
      \only<2>{\includegraphics[width=7cm]{Cha4//fig4-12-2.pdf}}
      \only<3>{\includegraphics[width=7cm]{Cha4//fig4-12-3.pdf}}
      \only<4>{\includegraphics[width=7cm]{Cha4//fig4-12-4.pdf}}
      \only<5>{\includegraphics[width=7cm]{Cha4//fig4-12-5.pdf}}
      \only<6>{\includegraphics[width=7cm]{Cha4//fig4-12-6.pdf}}
      \only<7>{\includegraphics[width=7cm]{Cha4//fig4-12-7.pdf}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Smith圆图的应用}
  ...
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.6\linewidth}
      \only<1>{\includegraphics[width=6.5cm]{Cha4//fig4-13-1.pdf}}
      \only<2>{\includegraphics[width=6.5cm]{Cha4//fig4-13-2.pdf}}
      \only<3>{\includegraphics[width=6.5cm]{Cha4//fig4-13-3.pdf}}
      \only<4>{\includegraphics[width=6.5cm]{Cha4//fig4-13-4.pdf}}
      \only<5>{\includegraphics[width=6.5cm]{Cha4//fig4-13-5.pdf}}
    \end{column}
  \end{columns}
\end{frame}
