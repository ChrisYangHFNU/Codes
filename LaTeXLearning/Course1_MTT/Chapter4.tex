...
\begin{frame}{Smith圆图的应用}
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.6\linewidth}
      \only<1>{\includegraphics[width=7cm]{fig4-17-2.pdf}}
      \only<2>{\includegraphics[width=7cm]{fig4-17-3.pdf}}
      \only<3>{\includegraphics[width=7cm]{fig4-17-4.pdf}}
      \only<4>{\includegraphics[width=7cm]{fig4-17-5.pdf}}
      \only<5>{\includegraphics[width=7cm]{fig4-17-6.pdf}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.6\linewidth}
      \only<1>{\includegraphics[width=7cm]{fig4-17-7.pdf}}
      \only<2>{\includegraphics[width=7cm]{fig4-17-8.pdf}}
      \only<3>{\includegraphics[width=7cm]{fig4-17-9.pdf}}
      \only<4>{\includegraphics[width=7cm]{fig4-17-10.pdf}}
      \only<5>{\includegraphics[width=7cm]{fig4-17-11.pdf}}
    \end{column}
  \end{columns}
\end{frame}
