...
\begin{frame}{支节匹配器}
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.6\linewidth}
      \only<1>{\includegraphics[width=7cm]{fig4-39-1.pdf}}
      \only<2>{\includegraphics[width=7cm]{fig4-39-2.pdf}}
      \only<3>{\includegraphics[width=7cm]{fig4-39-3.pdf}}
      \only<4>{\includegraphics[width=7cm]{fig4-39-4.pdf}}
      \only<5>{\includegraphics[width=7cm]{fig4-39-5.pdf}}
      \only<6>{\includegraphics[width=7cm]{fig4-39-6.pdf}}
      \only<7>{\includegraphics[width=7cm]{fig4-39-7.pdf}}
      \only<8>{\includegraphics[width=7cm]{fig4-39-8.pdf}}
      \only<9>{\includegraphics[width=7cm]{fig4-39-9.pdf}}
      \only<10>{\includegraphics[width=7cm]{fig4-39-10.pdf}}
      \only<11>{\includegraphics[width=7cm]{fig4-39-11.pdf}}
      \only<12>{\includegraphics[width=7cm]{fig4-39-12.pdf}}
      \only<13>{\includegraphics[width=7cm]{fig4-39-13.pdf}}
      \only<14>{\includegraphics[width=7cm]{fig4-39-14.pdf}}
      \only<15>{\includegraphics[width=7cm]{fig4-39-15.pdf}}
      \only<16>{\includegraphics[width=7cm]{fig4-39-16.pdf}}
      \only<17>{\includegraphics[width=7cm]{fig4-39-17.pdf}}
      \only<18>{\includegraphics[width=7cm]{fig4-39-18.pdf}}
      \only<19>{\includegraphics[width=7cm]{fig4-39-19.pdf}}
      \only<20>{\includegraphics[width=7cm]{fig4-39-20.pdf}}
    \end{column}
  \end{columns}
\end{frame}
