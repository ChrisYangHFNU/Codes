...
\begin{tikzpicture}
    ...
    \begin{smithchart}[
        ...
        \coordinate [label=330:$A$] (a) at (2,1);
        \coordinate[label=330:$B$] (b) at (0.4,-0.2);
        \coordinate[label=330:$C$] (c) at (0.61,0.66);
        ...
        \node (H) [label=120:$EqualReflectionCoefficientCircle$,name path=H,draw=red,thick,circle through={(a)}]at (o) {};
