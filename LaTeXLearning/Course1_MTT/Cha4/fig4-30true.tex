...
\begin{tikzpicture}
    ...
    \begin{smithchart}[
        ...
        \addplot[domain=0:90,samples=600,color=blue]{1.59};
        \addplot[domain=0:90,samples=600,color=blue]{-1.59};

        \addplot+[mark=*,only marks,samples at={0,.02,...,100},
            mark options={solid},color={blue},mark size=.1,line width=1](2,x);
        \addplot+[mark=*,only marks,samples at={0,-.02,...,-100},
            mark options={solid},color={blue},mark size=.1,line width=1](2,x);
        ...
        \coordinate [label=330:$A$] (a) at (2,2);
        \coordinate [label=330:$B$] (b) at (0.25,-0.25);
        \coordinate [label=350:$C$] (c) at (1,1.59);
        \coordinate [label=90:$D$] (d) at (0,-1.59);
        ...
        \draw[thick,blue] (o) -- ($ (o) !2.3! (b) $) coordinate (e);
        \draw[thick,blue] (o) -- ($ (o) !2.3! (c) $) coordinate (f);
        ...
        \draw [thick,blue,-{Stealth[length=6mm,width=4mm]}]
        let
           \p2=($(o) - (s)$),
           \n2={veclen(\x2,\y2)}
        in
        ...
        \draw [thick,red,-{Stealth[length=6mm,width=4mm]}]
        let
           \p3=($(o) - (k)$),
           \n3={veclen(\x3,\y3)}
        in
