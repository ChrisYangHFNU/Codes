...
\begin{frame}{电报的发明}
  \begin{columns}
    \begin{column}{0.5\linewidth}
      \begin{figure}
        \includegraphics[width=3.5cm]{Cha1//Morse.jpeg}
...
\begin{frame}{电报的发明}
  ...
  \end{itemize}
  \centering
  \includegraphics[width=8cm]{Cha1//morsecode}
\end{frame}

\begin{frame}{电话的发明}
  \begin{columns}
    \begin{column}{0.35\linewidth}
      \includegraphics[height=6.5cm]{Cha1//dianhua}
    \end{column}
    \begin{column}{0.65\linewidth}
      \begin{itemize}
...
\begin{frame}{电话的发明}
  \begin{columns}
    \begin{column}{0.4\linewidth}
      \begin{figure}
        \includegraphics[width=3.5cm]{Cha1//Bell.jpg}
...
\begin{frame}{电话的发明}
  \begin{columns}
    \begin{column}{0.5\linewidth}
      \includegraphics[width=5.5cm]{Cha1//Bell2}
    \end{column}
    \begin{column}{0.5\linewidth}
      \begin{itemize}
...
\begin{frame}{电话的发明}
  \begin{columns}
    \begin{column}{0.35\linewidth}
      \begin{figure}
        \includegraphics[width=3.5cm]{Cha1//pengmingbao}
        \caption{彭名保}
      \end{figure}
    \end{column}
    \begin{column}{0.65\linewidth}
...
\begin{frame}{电磁波的发现}
  \begin{columns}
    \begin{column}{0.35\linewidth}
      \begin{figure}
        \includegraphics[width=3.5cm]{Cha1//oersted.jpg}
        \caption{汉斯·克里斯蒂安·奥斯特 Hans Christian Oersted(1777 - 1851)}
      \end{figure}
    \end{column}
    \begin{column}{0.65\linewidth}
      \includegraphics[width=6.5cm]{Cha1//oerstedexperiment.jpg}
      \begin{itemize}
...
\begin{frame}{电磁波的发现}
  \begin{columns}
    \begin{column}{0.35\linewidth}
      \begin{figure}
        \includegraphics[width=3.5cm]{Cha1//faraday.jpg}
        \caption{迈克尔·法拉第Michael Faraday(1791-1867)}
      \end{figure}
    \end{column}
    \hfill
    \begin{column}{0.65\linewidth}
      \includegraphics[width=5cm]{Cha1//faradayexperiment.jpg}
      \begin{itemize}
        \item 英国物理学家、化学家
        \item 1831年发现电磁感应
      \end{itemize}
...
\begin{frame}{无线电报的发明}
  \begin{columns}
    \begin{column}{0.35\linewidth}
      \begin{figure}
        \includegraphics[width=3.5cm]{Cha1//popov.jpg}
        \caption{波波夫Popov, Aleksandr Stepanovic(1859 - 1906)}
      \end{figure}
    \end{column}
    \begin{column}{0.65\linewidth}
      \begin{figure}
        \includegraphics[width=6.5cm]{Cha1//wirelessreceiver.jpg}
...
\begin{frame}{无线电报的发明}
  \begin{columns}
    \begin{column}{0.35\linewidth}
      \begin{figure}
        \includegraphics[width=3.5cm]{Cha1//marconi2.jpg}
...
\begin{frame}{无线电通信的发明}
  \begin{columns}
    \begin{column}{0.35\linewidth}
      \includegraphics[width=3.5cm]{Cha1//broadcast1.jpg}
    \end{column}
    \begin{column}{0.65\linewidth}
      \begin{itemize}
...
\begin{frame}{无线电通信的发明}
  \begin{columns}
    \begin{column}{0.35\linewidth}
      \includegraphics[width=3.5cm]{Cha1//broadcast2.jpg}
    \end{column}
    \begin{column}{0.65\linewidth}
      \begin{itemize}
...
\begin{frame}{无线电通信的发明}
  \begin{columns}
    \begin{column}{0.35\linewidth}
      \includegraphics[width=3.5cm]{Cha1//radar.jpg}
    \end{column}
    \begin{column}{0.65\linewidth}
      \begin{itemize}
...
\begin{frame}{电与磁的转换}
  ...
  \begin{columns}
    \begin{column}{0.45\linewidth}
      \begin{figure}
        \includegraphics[width=4cm]{Cha1//oscillator.png}
        \caption{电磁振荡}
      \end{figure}
    \end{column}
    \begin{column}{0.45\linewidth}
      \begin{figure}
        \includegraphics[width=1.8cm]{Cha1//pendulum.png}
        \caption{单摆}
      \end{figure}
    \end{column}
  \end{columns}
...
\begin{frame}{微波的特点}
  ...
  \begin{columns}
    \begin{column}{0.44\linewidth}
      \begin{tcolorbox}[colback=blue!0,colframe=blue!40!black,title=微波与超短波、短波比较]
        微波与超短波、短波相比较大大扩展了通讯通道，开辟了微波通讯和卫星通讯。
      \end{tcolorbox}
    \end{column}
    \begin{column}{0.55\linewidth}
      \begin{tcolorbox}[colback=blue!0,colframe=blue!40!black,title=微波与光波比较]
...
\begin{frame}{微波的特点}
  ...
  \end{enumerate}
  \centering
  \includegraphics[width=6.5cm]{Cha1//cosmicwindow.png}
\end{frame}
