...
%   参阅《MATLAB数值计算（2021修订版）》（张志涌等译）的第8.1节，有助于理解本文件
...
if nargin == 0
   ...
   clf
   shg
   set(gcf,'name','Touchtone','menu','none','numbertitle','off','Color','w');
   ...
   text([13,63,113],206*[1,1,1],{'1209','1336','1447'});
   text(-20*[1,1,1,1],[25,75,125,175],{'697','770','852','941'})
   ...
   ax.power = axes('pos',[.60 .16 .36 .25],'TickDir','both');
   axis([500 1700 0 600])
   xlabel('f(Hz)')
   title('Amplitude')
...
elseif isequal(arg,'dialpad')
   ...
   axis([500 1700 0 1])
   set(gca,'xtick',[fr(k) fc(j)],'TickDir','both')
   xlabel('f(Hz)')
   title('Amplitude')
